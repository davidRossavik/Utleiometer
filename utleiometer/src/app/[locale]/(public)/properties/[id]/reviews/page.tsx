    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <ReviewsClient
        ...
        texts={{
          ...
          reviewReport: t("reviewReport"),
          reviewReportReasonLabel: t("reviewReportReasonLabel"),
          reviewReportReasonPlaceholder: t("reviewReportReasonPlaceholder"),
          reviewReportSubmit: t("reviewReportSubmit"),
          reviewReportCancel: t("reviewReportCancel"),
          reviewReportSubmitted: t("reviewReportSubmitted"),
          reviewReportAlreadySubmitted: t("reviewReportAlreadySubmitted"),
          reviewReportFailed: t("reviewReportFailed"),
